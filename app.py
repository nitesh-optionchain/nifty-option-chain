...
# ================= 5. LIVE HEADER (UPDATED) =================
if index_choice == "SENSEX":
    tv_html = """
    <div class="tradingview-widget-container" style="height:130px;width:100%;">
      <iframe scrolling="no" allowtransparency="true" frameborder="0" src="https://s.tradingview.com/embed-widget/single-quote/?locale=en#%7B%22symbol%22%3A%22BSE%3ASENSEX%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%7D" style="width: 100%; height: 100%;"></iframe>
    </div>
    """
    components.html(tv_html, height=130)

# ================= 6. SDK & DATA FETCH (CORRECTED) =================
...
if result and result.chain:
    ...
    ui["STRIKE"] = d_df.apply(get_strike_display, axis=1)
