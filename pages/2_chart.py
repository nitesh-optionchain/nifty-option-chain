...
# 🌐 PURE HISTORICAL PRODUCTION DATA PARSING PIPELINE (Strictly Real Data Mapping)
if os.path.exists(html_file_path):
    with open(html_file_path, "r", encoding="utf-8") as f:
        html_content = f.read()

    # Reset cache to ensure no stale blocks stay in memory
    ...
    # JSON dynamic generation matching original schema
