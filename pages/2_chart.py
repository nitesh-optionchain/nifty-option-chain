...
# Short Volatility Status (Bina faltu word repeat kiye)
if avg_iv > 18:
    vol_status = "High"
elif avg_iv < 12:
    vol_status = "Low"
...
# Exact Upper Box Matching Dark Card Design
st.markdown(f"""
<div style="background-color: #12161f; border: 1px solid #2d3748; border-radius: 14px; padding: 22px; margin-top: 10px; box-shadow: 0 4px 20px rgba(0,0,0,0.5);">
    ...
    <div style="display: flex; gap: 15px; flex-wrap: wrap;">
        ...
        <!-- Box 3: IV & Delta with Percentage -->
