...
USER_FILE = "authorized_users.json" # Naye users save karne ke liye
...
# --- Naye User Load/Save Logic (New Feature) ---
def load_users():
    default_admins = {
...
# --- Add New User (New Feature: Only for Admins) ---
if is_admin:
