...
if result and result.chain:
    ...
    ui = pd.DataFrame()
    ui["CE SIGNAL"] = d_df.apply(lambda r: get_signal_display(r, "CE"), axis=1)
    ...
    ui["PE SIGNAL"] = d_df.apply(lambda r: get_signal_display(r, "PE"), axis=1)
